...
public class ProgressActivity extends RelativeLayout {
    ...
    private static final String TAG_LOGIN = "ProgressActivity.TAG_LOGIN";
    ...
    private void init(AttributeSet attrs) {
        ...
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageWidth, 150);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageHeight, 150);
        ...
        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_emptyTitleTextColor, ContextCompat.getColor(getContext(), R.color.font2));

        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_emptyContentTextColor, ContextCompat.getColor(getContext(), R.color.font2));
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageWidth, 500);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageHeight, 300);
        ...
        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorTitleTextColor, ContextCompat.getColor(getContext(), R.color.font2));

        errorStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorContentTextColor, ContextCompat.getColor(getContext(), R.color.font2));

        errorStateButtonTextColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorButtonTextColor, ContextCompat.getColor(getContext(), R.color.white));

        errorStateBackgroundColor =
                typedArray.getColor(R.styleable.ProgressActivity_errorBackgroundColor, Color.TRANSPARENT);
        errorStateButtonBackgroundColor = typedArray.getResourceId(R.styleable.ProgressActivity_errorButtonBackgroundColor, Color.TRANSPARENT);
        typedArray.recycle();
    ...
    public void showLogin(Drawable errorImageDrawable, String errorTextTitle, String errorTextContent, String errorButtonText, OnClickListener onClickListener) {
        switchState(LOGIN, errorImageDrawable, errorTextTitle, errorTextContent, errorButtonText, onClickListener, Collections.<Integer>emptyList());
    }
...
//            errorStateImageView.requestLayout();
            ...
            if (errorStateButtonBackgroundColor != Color.TRANSPARENT) {
                errorStateButton.setBackgroundResource(errorStateButtonBackgroundColor);
            }
            layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
            layoutParams.addRule(CENTER_IN_PARENT);
