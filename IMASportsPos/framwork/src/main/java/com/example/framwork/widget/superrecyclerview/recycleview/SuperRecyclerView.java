...
public class SuperRecyclerView extends RecyclerView {
    ...
    public void setRefreshNomal(String refreshNomal) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setRefreshNomal(refreshNomal);
        }
    }

    public void setRefreshing(String refreshing) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setRefreshing(refreshing);
        }
    }

    public void setRefreshToRefresh(String refreshToRefresh) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setRefreshToRefresh(refreshToRefresh);
        }
    }

    public void setRefreshDone(String refreshDone) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setRefreshDone(refreshDone);
        }
    }
