...
public class ProgressButton extends View {
    ...
    public void setMdefaultRadius(float mdefaultRadius) {
        this.mdefaultRadius = mdefaultRadius;
        this.mRadius = mdefaultRadius;
    }
    ...
    private int proColor = Color.BLUE;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.ProgressButtonStyle);
        bgColor = obtainStyledAttributes.getColor(R.styleable.ProgressButtonStyle_pb_btn_bg, Color.RED);
        text = obtainStyledAttributes.getString(R.styleable.ProgressButtonStyle_pb_text);
        textColor = obtainStyledAttributes.getColor(R.styleable.ProgressButtonStyle_pb_text_color, Color.WHITE);
        mdefaultRadius = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.ProgressButtonStyle_pb_radius, 0);
        mRadius = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.ProgressButtonStyle_pb_radius, 0);
        proColor = obtainStyledAttributes.getColor(R.styleable.ProgressButtonStyle_pb_progress_color, Color.BLUE);
    ...
    private void initPaint() {
        ...
        paintText.setTextSize(dip2px(17));
        paintPro = new Paint();
