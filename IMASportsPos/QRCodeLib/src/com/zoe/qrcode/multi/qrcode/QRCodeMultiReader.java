...
package com.zoe.qrcode.multi.qrcode;
...
import com.zoe.qrcode.multi.MultipleBarcodeReader;
import com.zoe.qrcode.multi.qrcode.detector.MultiDetector;
import com.zoe.qrcode.qrcode.QRCodeReader;
...
public final class QRCodeMultiReader extends QRCodeReader implements
	...
	private static final class SAComparator implements Comparator<Result>,
		...
		public int compare(Result a, Result b) {
			int aNumber = Integer.valueOf(a.getResultMetadata()
					.get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE)
					.toString());
			int bNumber = Integer.valueOf(b.getResultMetadata()
					.get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE)
					.toString());
			if (aNumber < bNumber) {
				return -1;
